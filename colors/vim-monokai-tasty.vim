...
call Highlight('Delimiter', { 'fg': s:none, 'bg': s:none, 'style': s:none })
...
call Highlight('Identifier', { 'fg': s:none, 'bg': s:none, 'style': s:none })
...
call Highlight('Typedef', { 'fg': s:none, 'bg': s:none, 'style': s:none })
call Highlight('Function', { 'fg': s:light_green, 'bg': s:none, 'style': s:none })
call Highlight('@function.call', { 'fg': s:light_blue, 'bg': s:none, 'style': s:none })
call Highlight('@method.call', { 'fg': s:light_blue, 'bg': s:none, 'style': s:none })
call Highlight('@type.builtin', { 'fg': s:light_blue, 'bg': s:none, 'style': s:italic })
call Highlight('@namespace', { 'fg': s:light_green, 'bg': s:none, 'style': s:italic })
